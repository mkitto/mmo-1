...
namespace GameServer.Services
{
    ...
    class FriendService: Singleton<FriendService>
    {
        ...
        void OnFriendAddRequest(NetConnection<NetSession> sender, FriendAddRequest request)
        {
            ...
            Log.InfoFormat("OnFriendAddRequest: FromIf: {0}, FromName: {1}, ToID: {2}, ToName: {3}", request.FromId, request.FromName, request.ToId, request.ToName);
        ...
        {
            Character character = sender.Session.Character;
            Log.InfoFormat("OnFriendRemove: character: {0}, FriendId: {1}", character.Id, request.Id);
